...
<body>
  ...
  <main class="l-main">
    ...
    <div id="js-quizContainer" class="p-quiz-container l-container">
      ...
      <section class="p-quiz-box js-quiz" data-quiz="<? $i ?>">
          ...
          <ul class="p-quiz-box__answer__list">
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="<?=$j?>">
                <?=$choices[($i+1)*3-3]["name"]?>
                <i class="u-icon__arrow"></i>
              </button>
            </li>
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="<?=$j?>">
                <?=$choices[($i+1)*3-2]["name"]?>
                <i class="u-icon__arrow"></i>
              </button>
            </li>
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="<?=$j?>">
                <?=$choices[($i+1)*3-1]["name"]?>
                <i class="u-icon__arrow"></i>
              </button>
            </li>
          </ul>
        ...
        <?php if ($questions[$i]["supplement"] !== "なし") {; ?>
